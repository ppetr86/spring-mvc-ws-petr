...
public class AmazonSES {
    ...
    public void verifyEmail(UserDtoIn userDtoIn) {
        ...
        String htmlBodyWithToken = HTMLBODY.replace("$tokenValue", userDtoIn.getEmailVerificationToken());
        String textBodyWithToken = TEXTBODY.replace("$tokenValue", userDtoIn.getEmailVerificationToken());

        SendEmailRequest request = new SendEmailRequest()
                .withDestination(new Destination().withToAddresses(userDtoIn.getEmail()))
                .withMessage(new Message()
