...
@SpringBootTest
class UserEntityAddressCreditCardAsyncServiceImplTest {
    ...
    @Autowired
    UserEntityAddressCreditCardAsyncServiceImplTest(UserAddressCreditCardAsyncServiceImpl userAddressCreditCardAsyncService) {
